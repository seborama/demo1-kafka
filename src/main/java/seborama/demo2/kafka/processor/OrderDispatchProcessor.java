...
public class OrderDispatchProcessor extends AbstractProcessor<String, Order> {

    private final static org.slf4j.Logger log = LoggerFactory.getLogger(OrderDispatchProcessor.class);
