...
public class OrderDispatchServer extends OrderServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        OrderServer server = new OrderDispatchServer(consoleArguments
    ...
    public OrderDispatchServer(int sleepDuration) {
        super("Order Dispatch", OrderFulfilmentConsumer.create(sleepDuration));
    }
}
